 ...
 * access, then calls media_pipeline_run_gemv_test() which does the
...
// media_pipeline_run_gemv_test is declared in media_pipeline.h
...
main(int argc, char** argv)
{
	...
	status_t st = media_pipeline_run_gemv_test();
