...
struct intel_shared_info {
	...
	bool			frame_buffer_tiled;	// true if X-Tiled
	uint32			fence_register_index;	// which fence reg (0-15)
...
// Fence registers
// Gen4/Gen5 (i965/Ironlake): base 0x03000
// Gen6+ (Sandy Bridge+):     base 0x100000
...
#define FENCE_REG_TILE_WALK_Y			(1 << 1)
