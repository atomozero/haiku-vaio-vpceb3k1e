...
## 8. Project analysis notes & phase reports

This file catalogs the **external** reference material above. The project's own
analysis notes, design docs, and phase reports live alongside this file in
`docs/analysis/`, and every document (with its current status) is listed in the
